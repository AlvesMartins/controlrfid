...
from access.viewsets import UserViewSet, DeviceViewSet, LogSerializer, ZonaSerializer, ZonaViewSet, EventoSerializer, EventoViewSet
from access.views import DeviceIDList, homepage, personal_info, device_info, global_charts, register, LogIDList, ZonaIDList, EventoIDList, eventos_info, event_info
